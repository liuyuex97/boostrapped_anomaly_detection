...
if __name__ == '__main__':
    ...
    processors = dict()
    processors['ood_processor'] = import_class('processor.ood_processor.LE_Processor')
    ...
    processors['pretrain_byol_3views'] = import_class('processor.pretrain_byol_3views.BYOL_3views_Processor')
